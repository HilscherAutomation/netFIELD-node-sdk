 ...
 */
module.exports = function (jobId, containerId, page, limit, sortBy, sortOrder, callback) {
  ...
  try {
    ...
    var path = '/deployments/jobs/' + jobId + '/containers/' + containerId + '/methods?' + querystring.stringify(query);
